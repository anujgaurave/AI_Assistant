  ...
  const handleVoiceCommand = async (command) =>{
    if (command.startsWith("open ")) {
      ...
      const sitesMap = {
        ...
        facebook: "https://www.facebook.com/anujgauravemishra",
        google: "https://www.google.com",
        twitter: "https://www.twitter.com",
        instagram: "https://www.instagram.com/anujgaurave/",
      };
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm Friday, Your voice assistant created by Anuj Gaurave";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello friday")) {
      const response = "Hello Mishra, How can i help you";
      speakText(response);
      setInformation(response);
      return;
      ...
      setInformation(response);
      return;
    }else if (command.includes("who is lovely")) {
      const response = "Lovely is the daughter in law, of anuj";
      speakText(response);
      setInformation(response);
      return;
    }
